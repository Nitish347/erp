...
export declare const registerSuperAdmin: (data: RegisterData) => Promise<AuthResponse>;
export declare const loginAdmin: (data: LoginData) => Promise<AuthResponse>;
export declare const loginSuperAdmin: (data: LoginData) => Promise<AuthResponse>;
