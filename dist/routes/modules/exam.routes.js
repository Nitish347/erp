...
router.post('/', (0, auth_1.requireRole)(['teacher', 'admin']), examController.createExamHandler);
...
router.put('/:id', (0, auth_1.requireRole)(['teacher', 'admin']), examController.updateExamHandler);
// Delete exam - Teachers (own), Admins
router.delete('/:id', (0, auth_1.requireRole)(['teacher', 'admin']), examController.deleteExamHandler);
