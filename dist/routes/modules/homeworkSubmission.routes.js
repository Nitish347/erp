...
const submissionController = __importStar(require("../../controllers/homeworkSubmission.controller"));
const router = (0, express_1.Router)();
router.use(auth_1.authenticateToken);
// Create submission - Students, Admins
router.post('/', (0, auth_1.requireRole)(['student', 'admin']), submissionController.createSubmissionHandler);
...
router.post('/:id/grade', (0, auth_1.requireRole)(['teacher', 'admin']), submissionController.gradeSubmissionHandler);
exports.default = router;
//# sourceMappingURL=homeworkSubmission.routes.js.map