...
router.post('/', (0, auth_1.requireRole)(['admin']), subjectController.createSubjectHandler);
...
router.delete('/:id', (0, auth_1.requireRole)(['admin']), subjectController.deleteSubjectHandler);
