...
const NoticeSchema = new mongoose_1.Schema({
    ...
    issuedBy: { type: mongoose_1.Schema.Types.ObjectId, required: true },
...
exports.NoticeModel = mongoose_1.default.models.Notice || mongoose_1.default.model('Notice', NoticeSchema);
